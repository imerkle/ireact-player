...
var FullScreen = (_dec = (0, _mobxReact.inject)('VideoPlayerStore'), _dec(_class = (0, _mobxReact.observer)(_class = (_temp = _class2 = function (_React$Component) {
  ...
  _createClass(FullScreen, [{
    ...
    value: function render() {
      ...
      var _ref = VideoPlayerStore.isFullScreen ? ['fullscreen_exit', 'Exit Fullscreen'] : ['fullscreen', 'Fullscreen'],
      ...
      return _react2.default.createElement(
        _materialSon.Fa,
        null,
        this.props.makeButton(fsc, function () {
          _this2.handleFullScreenToggle();
        }, fst)
      );
    }
  }]);
